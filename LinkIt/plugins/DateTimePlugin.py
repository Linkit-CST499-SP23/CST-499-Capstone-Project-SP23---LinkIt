...
on how likely each item in the column is a date or time.
...
def get_confidence_score(col_name, col_vals):
    col_name_check = ("date" in col_name.lower() or "time" in col_name.lower())
...
"""
The get_elem_score() function takes in a boolean denoting whether 'date' or 'time' 
was found in the column name and one element from the column list and returns a confidence 
score on how the element is a date or time.
